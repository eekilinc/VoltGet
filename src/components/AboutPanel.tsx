...
export default function AboutPanel() {
  ...
  return (
    ...
    >
      {/* Hero Kartı */}
      <div
        className="card-premium glow-accent"
        style={{
          borderRadius: 20,
          padding: 24,
          textAlign: 'center',
      ...
      >
        ...
        <div
          ...
          style={{ fontSize: 13, marginTop: 4, maxWidth: 540, margin: '6px auto 0' }}
        >
          {t('aboutSubtitle')}
        </div>
      ...
      <div className="card-premium" style={{ borderRadius: 18, padding: 18 }}>
        ...
        >
          ...
          <div>
            {t('repository')}:{' '}
            <code style={{ background: 'var(--panel-2)', padding: '2px 6px', borderRadius: 4 }}>
              eekilinc/VoltGet
            </code>
          </div>
        </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span
              style={{
                ...
                padding: '2px 7px',
                borderRadius: 4,
                background: status?.ytdlpVer ? 'var(--badge-success-bg)' : 'var(--badge-danger-bg)',
                color: status?.ytdlpVer ? 'var(--badge-success-text)' : 'var(--badge-danger-text)',
                border:
                  '1px solid ' +
                  (status?.ytdlpVer ? 'var(--badge-success-border)' : 'var(--badge-danger-border)'),
                fontWeight: 800,
              }}
            >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span
              style={{
                ...
                padding: '2px 7px',
                borderRadius: 4,
                background: status?.ffmpegOk ? 'var(--badge-success-bg)' : 'var(--badge-danger-bg)',
                color: status?.ffmpegOk ? 'var(--badge-success-text)' : 'var(--badge-danger-text)',
                border:
                  '1px solid ' +
                  (status?.ffmpegOk ? 'var(--badge-success-border)' : 'var(--badge-danger-border)'),
                fontWeight: 800,
              }}
            >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span
              style={{
                ...
                border:
                  '1px solid ' +
                  (extConnected ? 'var(--badge-success-border)' : 'var(--badge-warning-border)'),
                fontWeight: 800,
              }}
            >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        <div className="card-premium" style={{ borderRadius: 16, padding: 16 }}>
          ...
          <div className="text-muted" style={{ fontSize: 11, marginTop: 8, lineHeight: 1.9 }}>
            • <b>Electron:</b> Electron 31 + Node.js 20 LTS
            <br />• <b>UI:</b> React 18 + TypeScript 5.5 + Vite 5<br />• <b>Engines:</b> yt-dlp +
            FFmpeg + 8-Thread HTTP Chunker
            <br />• <b>IPC:</b> WebSocket Server (127.0.0.1:8765)
            <br />• <b>Theme:</b> Glassmorphism, 7 Accent Colors
          </div>
        </div>
        ...
        <div className="card-premium" style={{ borderRadius: 16, padding: 16 }}>
          ...
          <div className="text-muted" style={{ fontSize: 11, marginTop: 8, lineHeight: 1.9 }}>
            • <b>Video:</b> MP4, MKV, WebM, MOV, AVI (4K, 1080p, 720p)
            <br />• <b>Stream:</b> HLS (m3u8, master.txt), DASH (mpd)
            <br />• <b>Audio:</b> MP3, M4A, FLAC, WAV, AAC, OGG (320 kbps)
            <br />• <b>Archive:</b> ZIP, RAR, 7Z, TAR, GZ, ISO, Torrent
            <br />• <b>Files:</b> PDF, DOCX, XLSX, EXE, MSI, APK
          </div>
        </div>
      </div>
