...
const dict: Record<Lang, Record<string, string>> = {
  tr: {
    appName: 'Flexplorer', appTagline: 'İndirme Yöneticisi',
  ...
  en: {
    appName: 'Flexplorer', appTagline: 'Download Manager',
